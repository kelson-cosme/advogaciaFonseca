    ...
    <section id="contato" className={styles.ctaSection}>
      ...
      <div className={styles.container}>
        <FadeIn direction="up" className={styles.content}>
          ...
          <a href="https://wa.me/5565999977272?text=Olá! Gostaria de uma análise personalizada para o meu caso com a Fonseca Advocacia." target="_blank" rel="noopener noreferrer" className={styles.whatsappButton}>
