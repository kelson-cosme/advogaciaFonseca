      ...
      <div className={styles.container}>
        <div className={styles.ctaBox}>
          <h2 className={styles.title}>
            Transforme desafios jurídicos em decisões mais seguras.
          </h2>
          <p className={styles.subtitle}>
            Proteção, estratégia e conhecimento para cuidar dos seus direitos, do seu patrimônio e da sua família.
          </p>
          <p className={styles.description}>
            Conte com uma atuação jurídica especializada, próxima e responsável para encontrar o melhor caminho em cada situação.
          </p>
          <a 
