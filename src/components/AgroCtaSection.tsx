      ...
      <div className={styles.container}>
        <div className={styles.ctaBox}>
          <h2 className={styles.title}>
            Transforme desafios jurídicos em<br />
            oportunidades de crescimento.
          </h2>
          <p className={styles.subtitle}>
            O futuro do agronegócio depende de quem age com segurança, planejamento e propósito.
          </p>
          <p className={styles.description}>
            Fale com um especialista em Direito Ambiental, Agrário e do Agronegócio e garanta<br />
            tranquilidade para o seu crescimento no campo.
          </p>
          <a 
