  ...
  return (
    <section id="areas" className={styles.section}>
      ...
      <FadeIn direction="up" className={styles.ctaContainer}>
        <a href="https://wa.me/5565999954884?text=Olá! Gostaria de falar com uma especialista sobre as áreas de atuação da Fonseca Advocacia." target="_blank" rel="noopener noreferrer" className={styles.ctaButton}>
