  ...
  return (
    <nav className={`${styles.navbar} ${isLightMode ? styles.themeLight : styles.themeDark} ${isScrolled ? (isLightMode ? styles.scrolledLight : styles.scrolledDark) : ''} ${isMenuOpen ? styles.navbarOpen : ''}`}>
      ...
      <div className={`${styles.navLinks} ${isMenuOpen ? styles.navLinksOpen : ''}`}>
        ...
        <a 
          href={isCarla ? "https://api.whatsapp.com/send?phone=5565999404884&text=" + encodeURIComponent("Olá, Dra. Carla. Gostaria de entrar em contato.") : isCimone ? "https://api.whatsapp.com/send?phone=5565999977272&text=" + encodeURIComponent("Olá, Dra. Cimone. Gostaria de entrar em contato.") : "#contato"} 
          className={styles.whatsappButton} 
          onClick={toggleMenu}
          target={isCarla || isCimone ? "_blank" : undefined}
          rel={isCarla || isCimone ? "noopener noreferrer" : undefined}
        >
