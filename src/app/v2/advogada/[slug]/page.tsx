...
import InteractiveProblems from "@/components/InteractiveProblems";
...
const lawyers = {
  carla: {
    ...
    heroImageV2: "/assets/heroCarlaV2.webp",
    stats: [
  ...
  cimone: {
    ...
    heroImageV2: "/assets/heroV2Cimone.webp",
    stats: [
    ...
    areasOverlayStyle: { backgroundColor: 'rgba(0, 0, 0, 0.65)' },
    areasTitleNormal1: "Soluções jurídicas para ",
    areasTitleHighlight: "proteger",
    areasTitleNormal2: "\nseus direitos e sua ",
    areasTitleHighlight2: "família",
    areasTitleNormal3: "",
    areasList: [
      {
        number: "01",
    ...
    docsBackgroundRight: "/assets/fundoCtaCimone.webp",
    docsTitleNormal1: "Envie os documentos pelo WhatsApp\npara uma ",
    docsTitleHighlight: "análise inicial",
    docsTitleNormal2: " do seu caso.",
    ...
    <main className={`${styles.container} ${styles[`theme_${slug}`]}`}>
      ...
      <section className={styles.hero}>
        <div className={styles.heroBackground}>
          {(lawyer as any).heroImageV2 && (
            <Image 
              src={(lawyer as any).heroImageV2} 
                  ...
                  <div className={styles.aboutImageInner}>
                    {lawyer.aboutImage && (
                      <Image 
                        ...
                        alt={`Foto ${lawyer.aboutTitleNormal}`}
                        fill
                        style={{ objectFit: 'cover' }}
                      />
                    )}
      ...
      {lawyer.problemsTitle && (
        <section className={styles.problemsSection} id="situacoes">
          ...
          <div className={styles.problemsContainer}>
            ...
            <InteractiveProblems 
              problems={lawyer.problemsList} 
              buttonText={lawyer.problemsButtonText} 
              buttonLink={getWhatsappLink('problems')}
              isInteractive={true} 
            />
          </div>
        </section>
